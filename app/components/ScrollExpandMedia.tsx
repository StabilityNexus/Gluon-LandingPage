    ...
    >
      <div className='sticky top-0 h-screen w-full flex items-center justify-center'>
        <div className='container mx-auto flex flex-col items-center justify-center relative z-10 px-4'>
          ...
          <motion.div
            className='relative rounded-3xl overflow-hidden shadow-2xl border border-[rgba(252,204,24,0.2)]'
            style={{
              width: mediaWidth,
              height: mediaHeight,
            }}
          >
            ...
            {/* Glow effect */}
            <div className='absolute inset-0 shadow-[0_0_100px_rgba(255,255,255,0.05)]' />
          </motion.div>
          ...
          >
            ...
            <div className={`flex flex-col items-center gap-3 ${textBlend ? 'mix-blend-difference' : ''}`}>
              <motion.h2 
                className='text-5xl md:text-6xl lg:text-8xl font-bold text-white text-center px-4'
            ...
            {date && (
              <motion.p 
                className='text-lg md:text-xl text-white/70 mt-8 text-center px-4 font-medium'
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            {scrollToExpand && (
              <motion.p 
                className='text-sm text-white/50 mt-10 animate-bounce scroll-hint flex items-center gap-2'
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
